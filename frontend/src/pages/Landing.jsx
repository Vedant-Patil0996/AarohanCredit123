        ...
        <div className="px-4 sm:px-6 lg:px-8 py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-4">
              <button
                className="px-4 py-2 text-white hover:text-[#00FF75] transition-colors rounded-xl"
              ...
              <button
                className="px-6 py-2.5 bg-[#00FF75] text-[#0a0d12] font-semibold rounded-xl 
                            hover:bg-[#0DF86A] transition-all shadow-[0_0_20px_#00ff75] 
                            hover:shadow-[0_0_30px_#00ff75]"
                onClick={() => (window.location.href = "/login")}
              >
                GET STARTED
              </button>
          ...
          <div className="md:hidden mt-2 mx-auto w-[94%] max-w-6xl bg-[#0a0d12]/95 backdrop-blur-xl border border-[#00FF75]/10 rounded-2xl shadow-[0_8px_24px_rgba(0,255,117,0.12)]">
            <div className="px-4 py-4 space-y-3">
              ...
              <div className="pt-4 space-y-2 border-t border-[#00FF75]/10">
                <Link
                  to="/login"
                  className="block w-full text-left py-2 text-white hover:text-[#00FF75] transition-colors"
                >
                  Log in
                </Link>
                ...
                <Link
                  to="/login"
                  className="block w-full py-2.5 bg-[#00FF75] text-[#0a0d12] font-semibold rounded-xl text-center"
                >
                  GET STARTED
                </Link>
              </div>
